...
ifneq ($(filter lahaina,$(DEVICE_SKU)),)
AB_OTA_PARTITIONS += \
    vbmeta_vendor
endif
...
# Bootloader
TARGET_BOOTLOADER_BOARD_NAME := $(DEVICE_SKU)
...
BOARD_BOOT_USB_CONTROLLER := 4e00000.dwc3
endif
BOARD_BOOT_USB_CONTROLLER ?= a600000.dwc3
BOARD_KERNEL_BASE := 0x00000000
BOARD_KERNEL_CMDLINE := \
    androidboot.hardware=qcom \
    androidboot.memcg=1 \
    androidboot.usbcontroller=$(BOARD_BOOT_USB_CONTROLLER) \
...
TARGET_KERNEL_CONFIG := vendor/$(DEVICE_SKU)-qgki_defconfig
...
TARGET_BOARD_PLATFORM := $(DEVICE_SKU)
...
TARGET_RECOVERY_FSTAB := $(COMMON_PATH)/$(DEVICE_SKU)/init/fstab.default
